...
- **Artificial Intelligence**: Exploring AI/ML applications in software development, including working with machine learning algorithms for credit scoring systems and staying current with AI-driven solutions for complex technical challenges.

- **DevOps & Cloud Architecture**: Enthusiastic about designing scalable cloud infrastructure, optimizing deployment pipelines, and implementing best practices in containerization and orchestration.
